...
class Catalogo:
    ...
    def agregar_producto(self, nombre, password, correo, imagen_url, telefono,):
        ...
        sql = "INSERT INTO productos (nombre, password, correo, imagen_url, telefono) VALUES (%s, %s, %s, %s, %s)"
...
catalogo = Catalogo(host='localhost', user='root', password='', database='myapp')
#catalogo = Catalogo(host='Tribilin74.mysql.pythonanywhere-services.com', user='Tribilin74', password='Boca2024', database='Tribilin74$miapp')
...
def agregar_producto():
    ...
    nombre = nombre + ', '
    nombre = nombre + request.form['nombre']
